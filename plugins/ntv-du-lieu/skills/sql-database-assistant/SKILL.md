...
- **CSDL đích = PostgreSQL THUẦN**, viết SQL tay. Repo **KHÔNG dùng ORM** (Prisma/Drizzle/TypeORM/SQLAlchemy) → **bỏ qua toàn bộ phần ORM** trong skill, kể cả `references/orm_patterns.md`.
